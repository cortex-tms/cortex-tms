...
> **Note**: This post has been superseded by [Cortex TMS Dogfooding Results: Quality Over Token Count](/blog/dogfooding-results/). Token optimization claims were invalidated by subsequent testing.
...
<Callout type="warning" title="External Review Feedback">
...
<Callout type="danger" title="Small Projects">
...
<Terminal
  title="measurement-log.md"
  language="markdown"
  content={`# measurement-log.md
...
<Terminal
  title="analyze-logs.sh"
  language="bash"
  content={`# Example for Claude Code (hypothetical - adapt to your tool)
...
<Terminal
  title="manual-setup.sh"
  language="bash"
  content={`mkdir -p docs/core docs/archive
...
<Terminal
  title="results-template.md"
  language="markdown"
  content={`## Context Optimization Measurement Results
...
<Terminal
  title="cortex-measure.sh"
  language="bash"
  content={`# Track context automatically
...
<Callout type="warning" title="Is Measurement Worth It?">
...
<Callout type="tip" title="Ongoing Research">
...
<Terminal
  title="manual-setup.sh"
  language="bash"
  content={`# Create basic structure
