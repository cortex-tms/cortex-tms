...
<Aside type="note">
  Anecdotal evidence from maintainers suggests significant reductions in PR iteration time when contributors use AI tools with access to architectural documentation. Your experience will vary based on project complexity and contributor familiarity with AI tools.
</Aside>
