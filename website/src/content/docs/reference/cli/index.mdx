...
<CardGrid>
  ...
  <Card title="dashboard" icon="laptop">
    **Interactive terminal dashboard**
    ...
    [View dashboard documentation](/reference/cli/dashboard/)
  </Card>
  ...
  <Card title="hooks" icon="setting">
    **Manage git hooks**
    ...
    [View hooks documentation](/reference/cli/hooks/)
  </Card>
</CardGrid>
...
:::note
The `version` field is the **config schema version** (currently `1.0.0`), not the Cortex TMS CLI version. It is used internally for future config migrations.
:::
...
- [cortex-tms hooks](/reference/cli/hooks/) - Git hook management
