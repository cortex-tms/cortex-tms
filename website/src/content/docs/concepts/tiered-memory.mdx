...
description: Understanding the HOT/WARM/COLD documentation architecture for organizing project context
---
...
- Use [`cortex-tms archive`](/reference/cli/archive/) to move completed tasks to COLD tier
- Use [`cortex-tms validate`](/reference/cli/validate/) to check documentation health
